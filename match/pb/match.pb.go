...
func (x *Interests) GetUserID() uint32 {
	if x != nil {
		return x.UserID
	}
	return 0
...
func (x *Interests) GetPhoto() string {
	if x != nil {
		return x.Photo
	}
	return ""
...
func (x *Interests) GetTime() string {
	if x != nil {
		return x.Time
	}
	return ""
...
var file_match_proto_rawDesc = []byte{
	...
	0x52, 0x0c, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x55, 0x73, 0x65, 0x72, 0x73, 0x22, 0x61,
	0x0a, 0x09, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x65, 0x73, 0x74, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x75,
	...
	0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x74, 0x6f,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x0a,
	0x04, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74, 0x69, 0x6d,
	0x65, 0x22, 0xab, 0x01, 0x0a, 0x0c, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x64, 0x55, 0x73, 0x65,
	...
	0x65, 0x49, 0x64, 0x22, 0x93, 0x01, 0x0a, 0x0d, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x73,
...
var file_match_proto_goTypes = []interface{}{
	...
	(*Interests)(nil),             // 5: Interests
	(*MatchedUsers)(nil),          // 6: MatchedUsers
	(*Images)(nil),                // 7: Images
	(*MatchResponse)(nil),         // 8: MatchResponse
...
var file_match_proto_depIdxs = []int32{
	...
	9, // 2: MatchResponse.error:type_name -> google.protobuf.Any
	9, // 3: MatchResponse.data:type_name -> google.protobuf.Any
	...
	3, // 7: MatchService.CreateIntrests:input_type -> IntrestRequest
	2, // 8: MatchService.GetAllInteretsRequests:input_type -> UserIdRequest
	8, // 9: MatchService.UplaodPhotos:output_type -> MatchResponse
	8, // 10: MatchService.SaveUserPrefrences:output_type -> MatchResponse
	8, // 11: MatchService.GetMatchedUsers:output_type -> MatchResponse
	8, // 12: MatchService.CreateIntrests:output_type -> MatchResponse
	8, // 13: MatchService.GetAllInteretsRequests:output_type -> MatchResponse
